...
\item And the all plans found are ones that the query optimizer under reasonable
  circumstances do generate.
\end{itemize}

The method of evaluation is therefore done by allowing the database to generate
