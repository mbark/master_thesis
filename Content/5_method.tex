...
several options to be set, the values used for the evaluation can be seen
...
identified in the first two tests.  As can be seen a small number of repetitions
is used and the sample size is minimal, this is as neither of these two options
seemed to affect the query plans chosen. For a further discussion about this see
Section~\ref{sec:ambigindexes}, where the results found for the initial tests is
discussed in detail.
